...
namespace LigaProDB.Controllers
{
    public class JugadoresController : Controller
    {
        ...
        {
            var ligaProDataBase = _context.Jugador.Include(j => j.Equipo);
            return View(await ligaProDataBase.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Edad,EquipoId,NumeroCamiseta,Goles,Asistencias,Sueldo,Posicion")] Jugador jugador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Edad,EquipoId,NumeroCamiseta,Goles,Asistencias,Sueldo,Posicion")] Jugador jugador)
        {
            if (id != jugador.Id)
            {
                return NotFound();
